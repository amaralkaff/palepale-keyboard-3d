...
/**
 * Item in *SwitchPlayground → Default → Primary → Swithces*
 */
export interface SwitchPlaygroundSliceDefaultPrimarySwithcesItem {
  /**
   * Switch field in *SwitchPlayground → Default → Primary → Swithces*
   *
   * - **Field Type**: Content Relationship
   * - **Placeholder**: *None*
   * - **API ID Path**: switch_playground.default.primary.swithces[].switch
...
export interface SwitchPlaygroundSliceDefaultPrimary {
  ...
  /**
   * Swithces field in *SwitchPlayground → Default → Primary*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: switch_playground.default.primary.swithces[]
   * - **Documentation**: https://prismic.io/docs/fields/repeatable-group
   */
  swithces: prismic.GroupField<
    Simplify<SwitchPlaygroundSliceDefaultPrimarySwithcesItem>
  >;
}
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      SwitchPlaygroundSlice,
      SwitchPlaygroundSliceDefaultPrimarySwithcesItem,
