...
export function Loader() {
  ...
  return (
    <div
      ref={containerRef}
      className="blue-gradient-bg fixed inset-0 z-100 flex h-full flex-col items-center justify-center gap-3 sm:gap-6"
    >
      <svg
      ...
      >
        <defs>
          <style>
            @import
            url('https://fonts.googleapis.com/css2?family=Roboto+Flex:opsz,slnt,wdth,wght@8..144,-10..0,25..151,100..1000&display=swap');
          </style>
        </defs>
        <text
          x="600"
