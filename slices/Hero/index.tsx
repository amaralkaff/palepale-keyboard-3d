...
const Hero: FC<HeroProps> = ({ slice }) => {
  return (
    <section
      ...
      className="blue-gradient-bg text-white relative h-dv text-shadow-black/30 text-shadow-lg "
    >
      ...
      <div className="hero-content absolute inset-x-0 top-1 h-dvh ">
        ...
        <Bounded fullWidth 
          ...
          <button className="font-bold-slanted group flex w-fit cursor-pointer items-center gap-1 rounded bg-[#01A7E1] px-3 py-1 text-2xl uppercase transition disabled:greyscale ">
